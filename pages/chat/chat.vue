<template>
	<view class="container">
		<view class="tui-chat-content">
			...
			<view v-show="show">
				<view class="tui-label">开启AI对话</view>
				<view class="tui-chat-center">星期{{curDay(new Date())}} {{curTime(new Date())}}</view>
...
<script>
	...
	export default {
		...
		computed: {
			...
			curTime() {
				return function(dateIns) {
					return dateIns.getHours() + ":" + dateIns.getMinutes()
				}
			}
		},
		data() {
